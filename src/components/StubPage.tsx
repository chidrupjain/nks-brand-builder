...
const StubPage = forwardRef<HTMLDivElement, StubPageProps>(
  ({ title, badge = "ARN-345665", description = "This page is under development. Please check back soon." }, ref) => (
    <div ref={ref}>
      ...
      <section className="py-16">
        <div className="container max-w-3xl text-center">
          ...
          <Link
            to="/"
            className="bg-gradient-cta text-navy-800 font-display font-bold text-sm px-8 py-4 rounded-lg shadow-gold hover:shadow-lg transition-all"
          >
            Back to Home
          </Link>
